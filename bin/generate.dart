...
ArgParser _generateArgParser(I18nOption? i18nOption) {
  ...
  parser.addOption('source-dir', defaultsTo: 'res/string', callback: (String? x) {
    if (x != null && i18nOption != null) i18nOption.sourceDir = x;
  }, help: 'A source folder contains all string json files');

  parser.addOption('output-dir', defaultsTo: 'lib/generated', callback: (String? x) {
    if (x != null && i18nOption != null) i18nOption.outputDir = x;
  }, help: 'A output folder stores all generated files');

  parser.addOption('template-locale', defaultsTo: 'en', callback: (String? x) {
    if (x != null && i18nOption != null) i18nOption.templateLocale = x;
  },
      help:
